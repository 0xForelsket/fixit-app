          ...
          <div className="rounded-lg border p-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                type="number"
                defaultValue={8}
                className="w-24 rounded-lg border bg-background px-3 py-2 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
              />
...
function ToggleSetting({
  ...
  return (
    <label className="flex items-center justify-between rounded-lg border p-4 cursor-pointer hover:bg-muted/50 transition-colors">
      <div>
