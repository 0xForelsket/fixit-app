...
import { formatWorkOrderId, parseWorkOrderId } from "@/lib/format-ids";
...
export default async function WorkOrderDetailPage({ params }: PageProps) {
  ...
  // First, find the work order by displayId to get the UUID
  const workOrderLookup = await db.query.workOrders.findFirst({
