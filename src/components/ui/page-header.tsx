...
export function PageHeader({
  ...
  return (
    <div className={cn("animate-in relative", !compact && "space-y-8", className)}>
      ...
      <div className={cn(
        ...
        compact ? "sm:items-center pb-4 border-b" : "sm:items-end pb-8 border-b-2"
      )}>
        <div className="flex flex-col gap-1">
          {subtitle && (
            <div className={cn(
              ...
              <span className={cn("h-px bg-primary", compact ? "w-4" : "w-8")} />
              {subtitle}
            </div>
          )}
          <h1 className={cn(
