  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-4">
        <div className="bg-red-50 p-3 rounded-2xl border border-red-100 relative overflow-hidden group animate-stagger-1 animate-in slide-in-from-bottom-2 duration-500">
        ...
        <div className="bg-blue-50 p-3 rounded-2xl border border-blue-100 relative overflow-hidden group animate-stagger-2 animate-in slide-in-from-bottom-2 duration-500">
        ...
        <div className="bg-orange-50 p-3 rounded-2xl border border-orange-100 relative overflow-hidden group animate-stagger-3 animate-in slide-in-from-bottom-2 duration-500">
