        ...
        <main className="px-6 md:px-12 max-w-7xl mx-auto pt-16 md:pt-24 pb-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="space-y-8">
              <h1 className="text-5xl md:text-7xl font-serif font-medium leading-[1.05] tracking-tight">
                Maintenance <br />
                <span className="underline decoration-2 decoration-black/20 underline-offset-4">management</span> <br />
                for everyone.
              </h1>
              <p className="text-xl md:text-2xl text-black/70 leading-relaxed max-w-lg font-light">
                The open-source CMMS alternative. Host it yourself, customize it endlessly, and own your operational data completely.
              </p>
              <div className="pt-4 flex flex-wrap gap-4">
                ...
                <Button asChild variant="outline" size="lg" className="border-black/20 hover:bg-black/5 rounded-xl px-8 h-12 text-base font-medium">
          ...
          <div className="mt-32 space-y-12">
               <div className="border-t border-black/10 pt-8 flex items-baseline justify-between">
                  <h2 className="text-sm font-bold tracking-widest uppercase opacity-60">Core Capabilities</h2>
                  <Link href="/docs" className="hidden md:flex items-center gap-2 text-sm font-medium hover:opacity-70 transition-opacity">
               ...
               <div className="bg-[#E6E4D9] rounded-[2rem] p-8 md:p-12">
                  <div className="md:flex items-start justify-between gap-12">
                      <div className="space-y-6 max-w-xl">
                          <h3 className="text-3xl font-serif font-medium">Community Driven</h3>
                          <p className="text-lg text-black/70">
                              Built by developers, for developers and facility managers. Contribute features, fix bugs, and shape the future of open maintenance software.
                          </p>
                          <ul className="space-y-3 pt-4">
                              <li className="flex items-center gap-3 text-sm font-medium opacity-80">
                                  <Code2 className="h-5 w-5" /> Modern Stack (Next.js, Drizzle, Lucide)
                              </li>
                              <li className="flex items-center gap-3 text-sm font-medium opacity-80">
                      ...
                      <div className="mt-8 md:mt-0 flex-shrink-0">
                           <Button variant="outline" asChild className="border-black/20 hover:bg-black/5 rounded-lg">
                              <Link href="https://github.com/0xForelsket/fixit-app">
                                View Source Code
                              </Link>
                           </Button>
           ...
           <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12">
              <div className="space-y-4">
                  <div className="flex items-center gap-2">
                       ...
                       <img src="/logo.svg" alt="FixIt Logo" className="h-6 opacity-80" />
                  </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-24 text-sm">
                  <div className="space-y-4">
                      <h4 className="font-bold opacity-50 uppercase tracking-wider text-xs">Project</h4>
                      <ul className="space-y-3 opacity-80">
                          <li><Link href="https://github.com/0xForelsket/fixit-app" className="hover:opacity-100">GitHub</Link></li>
                          <li><Link href="/docs" className="hover:opacity-100">Documentation</Link></li>
                          <li><Link href="/roadmap" className="hover:opacity-100">Roadmap</Link></li>
                      </ul>
                  </div>
                  <div className="space-y-4">
