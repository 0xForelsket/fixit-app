...
import { and, asc, count, desc, eq, gte, like, lt, or, sql, sum } from "drizzle-orm";

// ==================== Types ====================

export type SparePartCategory = "electrical" | "mechanical" | "hydraulic" | "pneumatic" | "consumable" | "safety" | "tooling" | "other";
...
export interface CreateSparePartData {
	...
	category: "electrical" | "mechanical" | "hydraulic" | "pneumatic" | "consumable" | "safety" | "tooling" | "other";
