...
const deployMethods = [
  ...
  },
  {
    ...
    icon: Zap,
    description:
      "One-click deployment with integrated CI/CD and edge optimization.",
  ...
  },
  {
    ...
    icon: Server,
    description:
      "Deploy in seconds with managed PostgreSQL and internal networking.",
...
const envVars = [
  ...
  {
    key: "AUTH_SECRET",
    description: "Secret for Auth.js session encryption.",
    required: true,
  },
  {
    key: "NEXT_PUBLIC_APP_URL",
    description: "The public URL of your instance.",
    required: true,
  },
  {
    key: "S3_UPLOAD_BUCKET",
    description: "Bucket name for asset storage.",
    required: false,
  },
];
        ...
        <header className="mb-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl font-light leading-relaxed">
              FixIt is infrastructure-agnostic. Deploy on-premise for total
              privacy, or in the cloud for global availability.
            </p>
          </motion.div>
        </header>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-6">
                  <div
                    className={`p-3 rounded-xl ${method.recommended ? "bg-primary text-primary-foreground" : "bg-secondary"}`}
                  >
                    <method.icon className="h-6 w-6" />
                  </div>
                  {method.recommended && (
                    <span className="text-[8px] font-mono font-black uppercase tracking-[0.2em] bg-primary text-primary-foreground px-2 py-1 rounded">
                      Recommended
                    </span>
                  )}
                </div>
                <h2 className="text-2xl font-black font-mono tracking-tighter uppercase mb-2">
                  {method.name}
                </h2>
                ...
                {method.command ? (
                  <div className="relative group">
                    ...
                    <div className="absolute top-2 left-4 text-[8px] font-mono uppercase font-bold text-muted-foreground/50">
                      Terminal
                    </div>
                    <button
                  ...
                  <Button
                    asChild
                    className={`w-full h-12 rounded-xl group font-black uppercase tracking-widest text-[10px] ${method.color}`}
                  >
        ...
        <section className="mb-48 grid lg:grid-cols-2 gap-16">
          <div className="space-y-8">
            ...
            <p className="text-muted-foreground font-light">
              Configure your instance using standard key-value pairs. All
              sensitive data is encrypted at the protocol layer.
            </p>
              ...
              {envVars.map((v) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <code className="text-[10px] font-black font-mono text-primary">
                      {v.key}
                    </code>
                    {v.required && (
                      <span className="text-[8px] font-mono bg-rose-500/10 text-rose-500 px-1 py-0.5 rounded">
                        REQUIRED
                      </span>
                    )}
                  </div>
          ...
          <div className="space-y-8">
              ...
              {[
                {
                  ...
                  icon: Database,
                  detail: "Ensure PostgreSQL 15+ is reachable",
                },
                {
                  title: "Storage Configuration",
                  icon: Cloud,
                  detail: "S3-compatible bucket or local disk",
                },
                {
                  title: "Network Privacy",
                  icon: ShieldCheck,
                  detail: "Configure SSL and CORS headers",
                },
                {
                  title: "Global CDN",
                  icon: Globe,
                  detail: "Optional: Set up edge caching for assets",
                },
              ].map((step, i) => (
            ...
            <div className="p-6 bg-secondary/50 border border-border rounded-2xl flex items-center justify-between">
              ...
              <Button
                variant="outline"
                size="sm"
                className="rounded-none uppercase font-black text-[10px] tracking-widest"
              >
                Access Docs
              </Button>
            </div>
        ...
        <section className="py-24 border-t border-border text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              FixIt is built on the principle that your operational data belongs
              to you. No shadows, no telemetry, no backdoors. Just pure
              maintenance engineering.
            </p>
            <Button
              size="lg"
              className="h-16 px-12 rounded-none font-black uppercase tracking-widest text-xs group"
            >
